...
Brf-mode adds functionality from the legendary DOS editor [[https://en.wikipedia.org/wiki/Brief_%28text_editor%29][Brief]] to Emacs.
...
:END:
   ...
   - Inclusive Mark (Alt-m)
     ...
     "Non-inclusive Mark" and is the only kind supported in Brf-mode. I don't think it makes any practical difference
